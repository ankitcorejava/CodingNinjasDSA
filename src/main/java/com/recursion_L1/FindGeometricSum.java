 ...
 * explanation ( Input/output format, Notes, Images ) Input format : Integer k
 * Output format : Geometric sum (upto 5 decimal places) Constraints : 0 <= k <=
...
public class FindGeometricSum {
	...
	public static double findGeometricSum(int k) {
		...
		double subOutPut = findGeometricSum(k - 1);

		return ((double)(1 / Math.pow(2, k)) + subOutPut);
